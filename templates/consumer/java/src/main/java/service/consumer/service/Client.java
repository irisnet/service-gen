...
public class Client {
    ...
    public Client(String algorithm, String rpc, String grpc, String chainID, String fee) throws URISyntaxException {
        ...
        String amount = fee.replaceAll("[^0-9]", "");
        String denom = fee.replaceAll( "[^a-z]", "");
