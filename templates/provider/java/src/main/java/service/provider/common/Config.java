package service.provider.common;
...
public class Config {
  ...
  private static final String DefaultChainId = "iris";
  ...
  private static final String DefaultKeyName = "sp";
  ...
  private static String ConfigPath = System.getProperty("user.home") + "/." + ServiceName + "-sp/config.yaml";
